...
const createExam = async (req, res, next) => {
  ...
  saveExam = new Exam({
    ...
    startTime: moment(startTime1).add(6, "hours"),
    endTime: moment(endTime1).add(6, "hours"),
...
const updateExam = async (req, res, next) => {
  ...
  let saveExamUpd = {
    ...
    examVariation: Number(examVariation),
    examFreeOrNot: JSON.parse(examFreeOrNot),
    startTime: moment(new Date(startTime)).add(6, "hours"),
    endTime: moment(new Date(endTime)).add(6, "hours"),
    duration: Number(duration),
